...
const AppBanner = ({ customData }) => {
    const title = customData?.title || "Shop Faster with SukaPrint App";
    const subtitle = customData?.subtitle || "Available on iOS and Android. Download now and get exclusive app-only deals!";
    const image = customData?.image || "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&q=80&w=400";
    const playStoreLink = customData?.playStoreLink || "#";
    const appStoreLink = customData?.appStoreLink || "#";
